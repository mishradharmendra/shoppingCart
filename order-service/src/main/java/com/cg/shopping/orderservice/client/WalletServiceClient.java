...
@FeignClient(name = "WALLET-SERVICE", url = "http://localhost:8080/wallet", configuration = MyRestTemplateConfig.class)
public interface WalletServiceClient {
    ...
    ResponseEntity<Wallet> getByCustomerId(@RequestParam(value = "customerId") int customerId);
}
